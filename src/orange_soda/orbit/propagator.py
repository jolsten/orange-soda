...
from orange_soda.orbit.switcher import (
    EpochSwitcher,
    MidpointSwitcher,
    SwitchingStrategy,
    TCASwitcher,
)
from orange_soda.orbit.utils import ensure_datetime64, jday_datetime64

try:
    from itertools import pairwise
except ImportError:
    from orange_soda.orbit.utils import pairwise_recipe as pairwise
